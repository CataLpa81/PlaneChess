...
Dice_Server::Dice_Server()
{
	this->texture.loadFromFile("./data/Entity/Dice_Server.png");
...
void Dice_Server::input(sf::Event& event)
{
	if (doDice_Server)
	{
...
void Dice_Server::Rander()
{
	window.draw(this->sprite);
}

void Dice_Server::SetNumberAnim()
{
	switch (Number)
	{
	case 1:
